...
void init() {
  ...
  if (myip == init_instance::get_thread_ip(0)) {
    ...
    *state = RUN_STATE;
    pthread_attr_setstacksize(&__pthread_attr_0, PTHREAD_STACK_MIN+1048576);
    pthread_attr_init(&__pthread_attr_0);
  ...
  if (myip == init_instance::get_thread_ip(1)) {
    ...
    int *state = info->get_state_flag();
    *state = RUN_STATE;
    pthread_attr_setstacksize(&__pthread_attr_1, PTHREAD_STACK_MIN+1048589);
    pthread_attr_init(&__pthread_attr_1);
  ...
  if (myip == init_instance::get_thread_ip(2)) {
    ...
    int *state = info->get_state_flag();
    *state = RUN_STATE;
    pthread_attr_setstacksize(&__pthread_attr_2, PTHREAD_STACK_MIN+1048576);
    pthread_attr_init(&__pthread_attr_2);
