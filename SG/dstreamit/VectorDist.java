...
class Worker extends Filter // VectorDist.str:1
{
  public Worker()
  {
  }
  public void work() { // VectorDist.str:2
    float x = inputChannel.popFloat(); // VectorDist.str:3
    float y = inputChannel.popFloat(); // VectorDist.str:4
    outputChannel.pushFloat(((x - y) * (x - y))); // VectorDist.str:5
  }
  public void init() { // VectorDist.str:1
    setIOTypes(Float.TYPE, Float.TYPE); // VectorDist.str:1
    addSteadyPhase(2, 2, 1, "work"); // VectorDist.str:2
  }
}
public class VectorDist extends StreamItPipeline // VectorDist.str:9
{
  public void init() { // VectorDist.str:9
    add(new MemoryReader("in_buff", 0, Float.TYPE)); // VectorDist.str:10
    add(new Worker()); // VectorDist.str:11
    add(new MemoryWriter("out_buff", 0, Float.TYPE)); // VectorDist.str:12
  }
}
